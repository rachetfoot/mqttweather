...
class MqttWeather():
    ...
    def programend(self):
        ...
        self.mqttclient.publish(self.mqtt_base_topic+'/bridge/state', payload='stopped', qos=0, retain=True)   
    ...
    def mqtt_on_connect(self, client, userdata, flags, rc):
        try:
            ...
            self.mqttclient.publish(self.mqtt_base_topic+'/bridge/state', payload='running', qos=0, retain=True)
        except Exception as e:
